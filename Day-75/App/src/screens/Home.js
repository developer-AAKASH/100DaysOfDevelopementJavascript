...
import { removeTask, markCompleted } from '../action/list';

// TODO: action to perform in redux

const Home = ({navigation, markCompleted, removeTask, listState }) => {
              ...
              <ListItem icon key={season.id} style={styles.listItem} noBorder>
                ...
                <Right>
                  <CheckBox
                    ...
                    onPress={() => markCompleted(season.id)}
                  />
                </Right>
              </ListItem>
            ))}
...
const mapDispatchToProps = {
    ...
    markCompleted: (taskId)=> markCompleted(taskId)
};
